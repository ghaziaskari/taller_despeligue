...
# web application at http://ghaziaskari.pythonanywhere.com/
...
#import sys
#
#path = '/home/ghaziaskari/path/to/my/app
...
#import sys
#
## assuming your django settings file is at '/home/ghaziaskari/mysite/mysite/settings.py'
## and your manage.py is is at '/home/ghaziaskari/mysite/manage.py'
#path = '/home/ghaziaskari/mysite'
#if path not in sys.path:
#    sys.path.append(path)
#
...
import sys
#
## The "/home/ghaziaskari" below specifies your home
## directory -- the rest should be the directory you uploaded your Flask
## code to underneath the home directory.  So if you just ran
## "git clone git@github.com/myusername/myproject.git"
## ...or uploaded files to the directory "myproject", then you should
## specify "/home/ghaziaskari/myproject"
path = '/home/ghaziaskari/taller_despeligue/'
if path not in sys.path:
    sys.path.append(path)
#
